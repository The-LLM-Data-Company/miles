...
class StreamingRolloutManager:
    ...
    async def get_next_groups(
        ...
        *,
        ...
        empty_wait_s = 0.0
        dropped_groups = 0
        dropped_staleness_values: list[int] = []

        max_weight_lag = getattr(self.args, "pipeline_max_weight_lag", None)
        drop_stale_groups = isinstance(max_weight_lag, int) and max_weight_lag >= 0
        ...
        while len(groups) < num_groups:
            ...
            if drop_stale_groups and staleness > max_weight_lag:
                dropped_groups += 1
        ...
        return groups, {
            ...
            "dropped_staleness_values": dropped_staleness_values,
        }
